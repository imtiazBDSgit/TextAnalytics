...
#loading packages for required for text analysis
library(text2vec)
library(data.table)
library(stringr)
library(tm)
...
temp.text = readLines('https://raw.githubusercontent.com/imtiazBDSgit/TextAnalytics/master/Q25.txt')  # Q25.txt for ice-cream data, india strikes back twitter.csv
head(temp.text, 5)
